...
let g:ale_c_gcc_options = '-pedantic -Wall -Werror -Wextra -I./includes -I../includes -I../../../includes -I../../includes -I../includes -I./includes -I../../../include -I../../include -I../include -I./include -I./libft/includes -I../libft/includes -I../../libft/includes'
